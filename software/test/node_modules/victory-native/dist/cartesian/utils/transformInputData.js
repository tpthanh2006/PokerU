 ...
 */
const transformInputData = ({ data: _data, xKey, yKeys, outputWindow, domain, domainPadding, xAxis, yAxes, }) => {
    ...
    const yAxesTransformed = (_a = (yAxes !== null && yAxes !== void 0 ? yAxes : [{}])) === null || _a === void 0 ? void 0 : _a.map((yAxis) => {
        ...
        const yScaleRange = (() => {
            ...
            const yLabelPosition = yAxis === null || yAxis === void 0 ? void 0 : yAxis.labelPosition;
