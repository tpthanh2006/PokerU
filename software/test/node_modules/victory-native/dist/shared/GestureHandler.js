...
const GestureHandler = ({ gesture, dimensions, transformState, debug = false, }) => {
    const { x, y, width, height } = dimensions;
    const style = (0, react_native_reanimated_1.useAnimatedStyle)(() => {
        let m4 = transform_1.identity4;
        if (transformState === null || transformState === void 0 ? void 0 : transformState.matrix.value) {
            m4 = (0, react_native_skia_1.convertToColumnMajor)(transformState.matrix.value);
        }
        return {
            position: "absolute",
                ...
                { translateY: -height / 2 },
                {
                    matrix: m4
                        ? react_native_1.Platform.OS === "web"
                            ? (0, react_native_skia_1.convertToAffineMatrix)(m4)
                            : m4
                        : [],
                },
                { translateX: width / 2 },
